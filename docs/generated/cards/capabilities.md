...
| Solar | solar | sensor | Yes | Own picker item | Mode: live, today; Production; Invert Production; Consumption; Net Production; Battery; From Grid; To Grid; Max Power (kW) | Visible |
...
| Calendar | ha_calendar | calendar | Yes | Own picker item | Display Mode: default, current; Modal Layout: default, column; Minutes before event: 1, 2, 3, 5, 10 | Visible |
