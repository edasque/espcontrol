...
| [solar.md](../docs/card-types/solar.md) | `solar` |
...
| [meeting-calendar.md](../docs/card-types/meeting-calendar.md) | `ha_calendar` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `(empty)` | Switch | `src/webserver/types/switch.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_media.h`, `components/espcontrol/button_grid_subpages.h` | `light`, `switch`, `input_boolean`, `fan` | Yes | Large Active Display Numbers; Confirmation Required: default, off, on, both; On State Pattern: default, stripes; Message; Confirm Button; Cancel Button | Visible | Contract, Codec, Parser, HA, Backup |
| `action` | Action | `src/webserver/types/action.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `scene`, `script`, `automation`, `button`, `input_button`, `input_boolean`, `input_number`, `input_select`, `select` | Yes | Large State Numbers; Confirmation Required; Fields; Message; Confirm Button; Cancel Button | Visible | Contract, Codec, Parser, HA, Backup |
| `vacuum` | Vacuum | `src/webserver/types/vacuum.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_vacuum.h` | `vacuum` | Yes | Type: status, start_stop, dock, pause_resume, clean_spot, locate, clean_area | Visible | Contract, Codec, Parser, HA, Backup |
| `lawn_mower` | Lawn Mower | `src/webserver/types/lawn_mower.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_lawn_mower.h` | `lawn_mower` | Yes | Type: status, start_mowing, dock, pause_resume | Visible | Contract, Codec, Parser, HA, Backup |
| `alarm` | Alarm | `src/webserver/types/alarm.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `alarm_control_panel` | Yes | Type: control_panel, away, home, night, vacation, disarm; PIN required for arming; PIN required for disarming; Visible Actions: away, home, night, vacation, disarm; Icon Display: static, status; Label Display: name, status | Visible | Contract, Codec, Parser, HA, Modals, Backup |
...
| `calendar` | Date & Time | `src/webserver/types/calendar.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_datetime_cards.h`, `components/espcontrol/button_grid_grid.h` | `sensor` | Yes | Type: clock, datetime, default, timezone; Large Clock | Visible | Contract, Codec, Parser, HA, Backup |
| `clock` | Date & Time | `src/webserver/types/clock.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | None | Yes | Type: clock, datetime, default, timezone; Large Clock | Visible | Contract, Codec, Parser, Backup |
| `climate` | Climate | `src/webserver/types/climate.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `climate` | Yes | Label Display: label, status, actual, target; Icon & Temperatures: icon, actual, target; Temperature Step: 1, 0.5; Large Temperature Numbers | Visible | Contract, Codec, Parser, HA, Modals, Backup |
| `climate_control` | All Controls | `src/webserver/types/climate.js` | `components/espcontrol/button_grid_climate.h`, `components/espcontrol/button_grid_config.h` | `climate` | Yes | Label Display: label, status, actual, target; Icon & Temperatures: icon, actual, target; Temperature Step: 1, 0.5; Large Temperature Numbers; Visible Tabs | Hidden | Contract, Codec, Parser, HA, Modals, Backup |
| `cover` | Cover | `src/webserver/types/slider.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_sliders.h`, `components/espcontrol/button_grid_subpages.h` | `cover` | Yes | Type: modal, default, tilt, toggle, open, close, stop, set_position; Position; Visible Tabs: position, controls, tilt | Visible | Contract, Codec, Parser, HA, Backup |
...
| `presence` | Presence | `src/webserver/types/presence.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_climate.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `binary_sensor`, `sensor`, `text_sensor` | Yes | None | Visible | Contract, Codec, Parser, HA |
| `fan_direction` | Fans | `src/webserver/types/fan.js` | `components/espcontrol/button_grid_fan.h` | `fan` | Yes | None | Visible | Contract, Codec, Parser, HA |
| `fan_oscillate` | Fans | `src/webserver/types/fan.js` | `components/espcontrol/button_grid_fan.h` | `fan` | Yes | None | Visible | Contract, Codec, Parser, HA |
| `fan_preset` | Fans | `src/webserver/types/fan.js` | `components/espcontrol/button_grid_fan.h` | `fan` | Yes | None | Visible | Contract, Codec, Parser, HA |
| `fan_speed` | Fans | `src/webserver/types/fan.js` | No direct match | `fan` | Yes | None | Visible | Contract, Codec, Parser, HA |
| `fan_control` | Fans | `src/webserver/types/fan.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_fan.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `fan` | Yes | Visible Tabs | Visible | Contract, Codec, Parser, HA, Backup |
| `fan_switch` | Fans | `src/webserver/types/fan.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_fan.h`, `components/espcontrol/button_grid_subpages.h` | `fan` | Yes | None | Visible | Contract, Codec, Parser, HA |
...
| `gate` | Gate | `src/webserver/types/gate.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `cover` | Yes | Interaction: default, open, close, stop; Display: label, status | Visible | Contract, Codec, Parser, HA, Backup |
...
| `light_control` | Lights | `src/webserver/types/light_temperature.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `light` | Yes | Visible Tabs: power, brightness, temperature, color | Hidden | Contract, Codec, Parser, HA, Backup |
| `lock` | Lock | `src/webserver/types/lock.js` | `components/espcontrol/button_grid_access_cards.h`, `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `lock` | Yes | Type: default, lock, unlock | Visible | Contract, Codec, Parser, HA, Backup |
| `media` | Media | `src/webserver/types/media.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_media.h`, `components/espcontrol/button_grid_subpages.h` | `media_player` | Yes | Type: control_modal, play_pause, previous, next, volume, position, now_playing, playlist; Type: default, state; Controls: default, progress, play_pause; Maximum Volume; Label Display: label, status; Top Left Display: icon, volume; Media Content ID / URI; Player Source / Input; Large Media Numbers | Visible | Contract, Codec, Parser, HA, Modals, Backup |
...
| `local_sensor` | Local Sensor | No current web type | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `sensor`, `text_sensor` | Yes | None | Hidden | Contract, Codec, Parser, HA |
...
| `solar` | Solar | `src/webserver/types/solar.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `sensor` | Yes | Mode: live, today; Production; Invert Production; Consumption; Net Production; Battery; From Grid; To Grid | Visible | Contract, Codec, Parser, HA, Backup |
| `subpage` | Subpage | `src/webserver/types/subpage.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_cards.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | None | No | Subpage Type: default, switch, lights, climate, presence, media, alarm, cover, garage, gate, lock, vacuum, lawn_mower, weather, sensor, image; Large State Numbers | Visible | Contract, Codec, Parser, Backup |
| `timezone` | Date & Time | `src/webserver/types/timezone.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_datetime_cards.h`, `components/espcontrol/button_grid_grid.h` | None | Yes | Type: clock, datetime, default, timezone; Large Clock | Visible | Contract, Codec, Parser, Backup |
| `weather` | Weather | `src/webserver/types/weather.js` | `components/espcontrol/button_grid_cards.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h`, `components/espcontrol/button_grid_subscriptions.h`, `components/espcontrol/button_grid_weather_forecast.h` | `weather` | Yes | Type: default, today, tomorrow; Large Temperature Numbers | Visible | Contract, Codec, Parser, HA, Backup |
...
| `weather_forecast` | Weather Forecast | `src/webserver/types/weather_forecast.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_cards.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h`, `components/espcontrol/button_grid_weather_forecast.h` | `weather` | Yes | None | Hidden | Contract, Codec, Parser, HA |
| `ha_calendar` | Calendar | `src/webserver/types/ha-calendar.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_ha_calendar.h` | `calendar` | Yes | Display Mode: default, current; Modal Layout: default, column; Minutes before event: 1, 2, 3, 5, 10 | Visible | Contract, Codec, Parser, HA, Backup |
