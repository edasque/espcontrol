...
| `ha_calendar` | Calendar | `src/webserver/types/ha-calendar.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_ha_calendar.h` | `calendar` | Yes | Display Mode: default, current; Modal Layout: default, column | Visible | Contract, Codec, Parser, HA, Backup |
