...
| `climate_control` | All Controls | `src/webserver/types/climate.js` | `components/espcontrol/button_grid_config.h` | `climate` | Yes | Label Display: label, status, actual, target; Icon & Temperatures: icon, actual, target; Temperature Step: 1, 0.5; Large Temperature Numbers; Visible Tabs | Hidden | Contract, Codec, Parser, HA, Modals, Backup |
...
| `solar` | Solar | `src/webserver/types/solar.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `sensor` | Yes | Mode: live, today; Production; Invert Production; Consumption; Net Production; Battery; From Grid; To Grid; Max Power (kW) | Visible | Contract, Codec, Parser, HA, Backup |
