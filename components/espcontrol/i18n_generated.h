...
inline const char *espcontrol_i18n_cs(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Přidejte toto zařízení v Home Assistant\npro povolení ovládání";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Povolte tomuto zařízení provádět\nakce Home Assistant";
...
inline const char *espcontrol_i18n_da(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Tilføj denne enhed i Home Assistant\nfor at aktivere styring";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Tillad denne enhed at udføre\nHome Assistant-handlinger";
...
inline const char *espcontrol_i18n_de(const char *text) {
  ...
  if (std::strcmp(text, "Yes") == 0) return "Ja";
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Fügen Sie dieses Gerät in Home Assistant hinzu,\num die Steuerung zu aktivieren";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Erlauben Sie diesem Gerät,\nHome Assistant-Aktionen auszuführen";
...
inline const char *espcontrol_i18n_es(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Añade este dispositivo en Home Assistant\npara habilitar el control";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Permite que este dispositivo realice\nacciones de Home Assistant";
...
inline const char *espcontrol_i18n_fi(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Lisää tämä laite Home Assistantissa,\njotta ohjaus otetaan käyttöön";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Salli tämän laitteen suorittaa\nHome Assistant -toimintoja";
...
inline const char *espcontrol_i18n_fr(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Ajoutez cet appareil dans Home Assistant\npour activer le contrôle";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Autorisez cet appareil à effectuer\ndes actions Home Assistant";
...
inline const char *espcontrol_i18n_hu(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Adja hozzá ezt az eszközt a Home Assistantban\na vezérlés engedélyezéséhez";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Engedélyezze, hogy ez az eszköz\nHome Assistant műveleteket végezzen";
...
inline const char *espcontrol_i18n_it(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Aggiungi questo dispositivo in Home Assistant\nper abilitare il controllo";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Consenti a questo dispositivo di eseguire\nazioni di Home Assistant";
...
inline const char *espcontrol_i18n_nb(const char *text) {
  ...
  if (std::strcmp(text, "Yes") == 0) return "Ja";
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Legg til denne enheten i Home Assistant\nfor å aktivere styring";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Tillat denne enheten å utføre\nHome Assistant-handlinger";
  if (std::strcmp(text, "Booting") == 0) return "Starter";
...
inline const char *espcontrol_i18n_nl(const char *text) {
  ...
  if (std::strcmp(text, "Yes") == 0) return "Ja";
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Voeg dit apparaat toe in Home Assistant\nom bediening in te schakelen";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Sta dit apparaat toe om\nHome Assistant-acties uit te voeren";
...
inline const char *espcontrol_i18n_pl(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Dodaj to urządzenie w Home Assistant,\naby włączyć sterowanie";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Zezwól temu urządzeniu wykonywać\nakcje Home Assistant";
...
inline const char *espcontrol_i18n_pt_br(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Adicione este dispositivo no Home Assistant\npara ativar o controle";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Permita que este dispositivo execute\nações do Home Assistant";
...
inline const char *espcontrol_i18n_ro(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Adăugați acest dispozitiv în Home Assistant\npentru a activa controlul";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Permiteți acestui dispozitiv să efectueze\nacțiuni Home Assistant";
...
inline const char *espcontrol_i18n_sk(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Pridajte toto zariadenie v Home Assistant\nna povolenie ovládania";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Povoľte tomuto zariadeniu vykonávať\nakcie Home Assistant";
...
inline const char *espcontrol_i18n_sl(const char *text) {
  ...
  if (std::strcmp(text, "Yes") == 0) return "Da";
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Dodajte to napravo v Home Assistant,\nda omogočite upravljanje";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Dovolite tej napravi izvajati\ndejanja Home Assistant";
...
inline const char *espcontrol_i18n_sv(const char *text) {
  ...
  if (std::strcmp(text, "Yes") == 0) return "Ja";
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Lägg till den här enheten i Home Assistant\nför att aktivera styrning";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Tillåt den här enheten att utföra\nHome Assistant-åtgärder";
...
inline const char *espcontrol_i18n_tr(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Kontrolü etkinleştirmek için\nbu cihazı Home Assistant’a ekleyin";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Bu cihazın Home Assistant eylemleri\nyapmasına izin verin";
...
inline const char *espcontrol_i18n_uk(const char *text) {
  ...
  if (std::strcmp(text, "Add this device in Home Assistant\nto enable control") == 0) return "Додайте цей пристрій у Home Assistant,\nщоб увімкнути керування";
  if (std::strcmp(text, "Allow this device to perform\nHome Assistant actions") == 0) return "Дозвольте цьому пристрою виконувати\nдії Home Assistant";
...
inline const char *espcontrol_i18n_key_en(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Add this device in Home Assistant\nto enable control";
  ...
  if (std::strcmp(key, "home_assistant") == 0) return "Home Assistant";
...
inline const char *espcontrol_i18n_key_cs(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Přidejte toto zařízení v Home Assistant\npro povolení ovládání";
...
inline const char *espcontrol_i18n_key_da(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Tilføj denne enhed i Home Assistant\nfor at aktivere styring";
...
inline const char *espcontrol_i18n_key_de(const char *key) {
  ...
  if (std::strcmp(key, "yes") == 0) return "Ja";
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Fügen Sie dieses Gerät in Home Assistant hinzu,\num die Steuerung zu aktivieren";
...
inline const char *espcontrol_i18n_key_es(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Añade este dispositivo en Home Assistant\npara habilitar el control";
...
inline const char *espcontrol_i18n_key_fi(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Lisää tämä laite Home Assistantissa,\njotta ohjaus otetaan käyttöön";
...
inline const char *espcontrol_i18n_key_fr(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Ajoutez cet appareil dans Home Assistant\npour activer le contrôle";
...
inline const char *espcontrol_i18n_key_hu(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Adja hozzá ezt az eszközt a Home Assistantban\na vezérlés engedélyezéséhez";
...
inline const char *espcontrol_i18n_key_it(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Aggiungi questo dispositivo in Home Assistant\nper abilitare il controllo";
...
inline const char *espcontrol_i18n_key_nb(const char *key) {
  ...
  if (std::strcmp(key, "yes") == 0) return "Ja";
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Legg til denne enheten i Home Assistant\nfor å aktivere styring";
...
inline const char *espcontrol_i18n_key_nl(const char *key) {
  ...
  if (std::strcmp(key, "yes") == 0) return "Ja";
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Voeg dit apparaat toe in Home Assistant\nom bediening in te schakelen";
...
inline const char *espcontrol_i18n_key_pl(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Dodaj to urządzenie w Home Assistant,\naby włączyć sterowanie";
...
inline const char *espcontrol_i18n_key_pt_br(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Adicione este dispositivo no Home Assistant\npara ativar o controle";
...
inline const char *espcontrol_i18n_key_ro(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Adăugați acest dispozitiv în Home Assistant\npentru a activa controlul";
...
inline const char *espcontrol_i18n_key_sk(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Pridajte toto zariadenie v Home Assistant\nna povolenie ovládania";
...
inline const char *espcontrol_i18n_key_sl(const char *key) {
  ...
  if (std::strcmp(key, "yes") == 0) return "Da";
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Dodajte to napravo v Home Assistant,\nda omogočite upravljanje";
...
inline const char *espcontrol_i18n_key_sv(const char *key) {
  ...
  if (std::strcmp(key, "yes") == 0) return "Ja";
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Lägg till den här enheten i Home Assistant\nför att aktivera styrning";
...
inline const char *espcontrol_i18n_key_tr(const char *key) {
  ...
  if (std::strcmp(key, "allow_this_device_to_perform_home_assistant_actions") == 0) return "Bu cihazın Home Assistant eylemleri\nyapmasına izin verin";
...
inline const char *espcontrol_i18n_key_uk(const char *key) {
  ...
  if (std::strcmp(key, "add_this_device_in_home_assistant_to_enable_control") == 0) return "Додайте цей пристрій у Home Assistant,\nщоб увімкнути керування";
