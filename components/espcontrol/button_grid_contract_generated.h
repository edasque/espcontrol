...
constexpr const char *CARD_CONTRACT_OPTION_NAME_BATTERY = "battery";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_CONSUMPTION = "consumption";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_FROM_GRID = "from_grid";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_IMAGE_REFRESH = "image_refresh";
constexpr const char *CARD_CONTRACT_OPTION_NAME_IMAGE_REFRESH_MODE = "image_refresh_mode";
constexpr const char *CARD_CONTRACT_OPTION_NAME_INTERNAL_MODE = "internal_mode";
constexpr const char *CARD_CONTRACT_OPTION_NAME_INVERT_PRODUCTION = "invert_production";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_MAX_POWER = "max_power";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_MODAL_LAYOUT = "modal_layout";
constexpr const char *CARD_CONTRACT_OPTION_NAME_MODE = "mode";
constexpr const char *CARD_CONTRACT_OPTION_NAME_NET = "net";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_PRODUCTION = "production";
